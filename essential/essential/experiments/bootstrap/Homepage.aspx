...
<html>
  ...
  <head>
      <title>Project demo homepage</title>
  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <p>Search for books online, exchange books with people near you!</p>
        <a href="#">Learn More</a>
      </div>
    </div> 
    <div class="book-guides">
      <div class="container">
       <h2>Getting started</h2>
        <p>Not sure where to start? We've created lists of current bestsellers for you!</p>
     <div class="row">
      <div class="col-md-4">
        <div class="thumbnail">
  ...
  <img src="http://goo.gl/0Kd7UO">
    ...
    <div class="learn-more">
	  ...
	  <div class="row">
		<div class="col-md-4">
			<h2>Write Reviews</h2>
			<p>Write about the books you have read, help other users know what they are about!</p>
