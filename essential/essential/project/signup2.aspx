        ...
        <div class="jumbotron">
            <div class="container">
                <div class="col-md-6">
                    ...
                    <br />
                    <asp:Button id="register_button" runat="server" type="button"  class="btn btn-primary" Text="Register" ></asp:Button>
                    
                </div>
                <div class="col-md-6">
                <h3>Already registered? <a href="login2.aspx">Login</a> to access your profile!</h3> <br /><br />
         </div>
        </div>
        </div>
        </form>
