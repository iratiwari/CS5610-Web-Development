...
function onload()
{
    ...
    function format_data(JSONResponse) {
        ...
        if (typeof item != 'undefined') {
            ...
            tbody += "</div>";
            tbody += "<br/>";
            tbody += '<a href="login.aspx"' + '<button type=button ; id=fav_button; class= "btn btn-success";> <span class="glyphicon glyphicon-star"></span>Add to Favourites </button>';
            tbody += "<br/>";
            tbody += '<a href="login.aspx"' + '<button type=button ; id=review_button; class= "btn btn-danger";> <span class="glyphicon glyphicon-pencil"></span>Add a Review </button>';
            tbody += "<br/>";
            tbody += '<a href="login.aspx"' + '<button type=button ; id=book_button; class= "btn btn-warning";> <span class="glyphicon glyphicon-book"></span>Add to My Bookshelf </button>';
